...
public static class Statics {
	...
	public static bool cutPath = false;

	public static float lineThickness = 0.15f;
	public static float lineRadius = lineThickness / 2f;
	public static float homotopyNearness = Statics.lineThickness * 1.5f;
	...
	public static float meanDist = 0.02f;
	//0.025f;
	public static float coarseDist = 0.1f;

	public static float bundleDist = 1f;

	public static float dotSpacer = 0.2f;
	public static float pathSpacer = 0.1f;
	public static float meshSpacer = 0.01f;

	public static float sphereRadius = 5f;

	public static float torusRadius1 = 6f;
	public static float torusRadius2 = 3f;
	...
	public static bool gluePaths = false;
	internal static int path1Set = -1;
